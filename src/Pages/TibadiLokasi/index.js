...
export default class TibadiLokasi extends Component {
	constructor(props) {
    super(props);
    this.state = {
		   nama: '',
 ...
 klikSimpan() {
     if (
      ...
      if (this.state.idEdit) {
        ...
        var urlAksi = this.url + '/?op=updateproses&invoice=' + invoice;
      } else {
		  var invoice =	this.props.route.params.invoice; 
       var urlAksi = this.url + '/?op=updateproses&invoice=' + invoice;
  	   var invoice =	this.props.route.params.invoice; 
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
			 ...
			 if (responseJson == 'ok') {
				 this.props.navigation.replace('Diperjalanan',{username:nama, nama:username, nama_produk : nama_produk, latitudecostumer:latitudecostumer,longitudecostumer:longitudecostumer,invoice:invoice,telepon:telepon});
			 }
...
>
        ...
        <View style={{backgroundColor: '#222a32', height: '20%'}}>
          <TouchableOpacity
            ...
            <Text style={styles.btntext}>Pesanan di Proses</Text>
          </TouchableOpacity>
		     <TouchableOpacity
