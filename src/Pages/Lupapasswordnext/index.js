...
export default class Lupapasswordnext extends Component {
  constructor(props) {
    super(props);
    this.state = {
      email: '',
 ...
 this.url = 'https://mutawif.co.id/api/muapi/lupapasswordmitra.php';
  }
  componentDidMount() {
    this.ambilListData();
  }
  ...
  klikSimpan() {
     if (
      ...
      alert('Silakan Konfirm Password');
    }
      ...
      if (this.state.idEdit) {
        ...
        var urlAksi = this.url + '/?op=ubahpassword';
      ...
      fetch(urlAksi, {
        ...
        .then(responseJson => {
			 ...
			 if (responseJson == 'ok') {
				 ...
				 this.props.navigation.replace('FrmLogin');
			 }
        ...
        <View style={{backgroundColor: 'white', flex: 1}}>
          {/* tengah */}
            <View style={styles.welcomebg}>
              ...
              <Text style={styles.welcome}  onPress={() => this.props.navigation.navigate('Formlogin')}>Lupa Password</Text>
           
 </View>

          <View style={styles.container}>
            <View style={styles.textinputmain}>
              <Image source={Logokey} style={styles.logoiconuser} />
              <TextInput
                style={styles.input}
