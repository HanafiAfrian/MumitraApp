...
<View style={{marginTop: -30}}>
      <Text  style={{color: 'white', fontSize: 16 }} >
                Nama Hotel Mekkah
					      ...
					      <Text style={{color: 'white', fontSize: 18,marginTop: -24, marginLeft: 152, }} >
						  :
                      </Text>
			  
			  
			    {this.state.listData.map((val, index) => (
                <Text style={{color: 'white', fontSize: 17,marginTop: -22, marginLeft: 160, }} >
             ...
             <Text  style={{color: 'white', fontSize: 16 }} >
			  ...
			  {this.state.listData.map((val, index) => (
                 ...
                 Waktu  Pemesanan
					      ...
					      <Text style={{color: 'white', fontSize: 18,marginTop: -24, marginLeft: 140, }} >
						  :
                      </Text>
			    {this.state.listData.map((val, index) => (
                 <View key={index}>
                    ...
                    <Text style={{color: 'white', fontSize: 18,marginTop: -24, marginLeft: 148, }} >
			   ...
			   <Text
                  style={styles.label}
                  style={{color: 'orange', fontSize: 18,marginTop: 22,}}
                  onPress={() =>
                    Linking.openURL(
                      'https://mutawif.co.id/api/muapi/invoiceselesai/Mutawfi.php',
                    )
                  }>
                  Download File Data Jemaah / Manifest
                </Text>
          </View>
