			  ...
			  {this.state.listData.map((val, index) => (
			    ...
			    {this.state.listData.map((val, index) => (
                 <View key={index}>
                    ...
                    <Text style={{color: 'white', fontSize: 18,marginTop: -24, marginLeft: 135, }} >
				  {val.nama_produk}   {val.jenis}   {val.jumlah} 
                      </Text>
			    ...
			    {this.state.listData.map((val, index) => (
                 ...
                 Tempat Pertemuan 
					     ...
					     <Text style={{color: 'white', fontSize: 18,marginTop: -24, marginLeft: 138, }} >
						  :
                      </Text>
			    {this.state.listData.map((val, index) => (
                 <View key={index}>
                    ...
                    <Text style={{color: 'white', fontSize: 18,marginTop: -24, marginLeft: 158, }} >
				  {val.tempat}    
                      </Text>
