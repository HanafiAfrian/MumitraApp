...
export default class Login extends Component {
  constructor(props) {
    ...
    this.url = 'https://mutawif.co.id/api/muapi/loginmitra.php';
  }
  componentDidMount() {
    this.ambilListData();
	var firebaseConfig = {
        ...
        <View style={{backgroundColor: 'white', flex: 1}}>
          {/* tengah */}
            <View style={styles.welcomebg}>
              ...
              <Text style={styles.welcome}  onPress={() => this.props.navigation.navigate('FrmLoginFirst')}>Login</Text>
